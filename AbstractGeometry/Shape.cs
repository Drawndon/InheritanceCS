...
namespace AbstractGeometry
{
	internal abstract class Shape
	{
		...
		public int StartX
		{
			get => startX; //Другая форма записи, не через return и фигурные скобки
			set => startX =
		...
		public double FilterSize(double value) => //Можно так
			value < MIN_SIZE ? MIN_SIZE :
			value > MAX_SIZE ? MAX_SIZE :
			value;
		public Color Color { get; set; } //System.Drawing
